...
% a = shadedErrorBar(x,y,{@mean,@std},'-r',1); 
% hold on
% y=ones(30,1)*x; y=y+0.06*y.^2+randn(size(y))*10;
% b = shadedErrorBar(x,y,{@mean,@std},'-b',1); 
% legend([a.mainLine, b.mainLine],'a', 'b') % Legend Feature is Useful
% hold off
%
%
...
% Ben Hack to add the possibility of user selectred RGB Triplets.
if isnumeric(cell2mat(lineProps));
    H.mainLine=plot(x,y,'Color',cell2mat(lineProps));
else
